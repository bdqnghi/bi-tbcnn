...
Here's our proposed Neural Network structure. In short, this structure is a variance of the Siamese Neural Network, which is  a class of Neural Network used for finding similarity or a relationship between two comparable things. The different here is that we don't use the contrastive loss function. Instead, we concat the features of 2 comparable things into 1 aggregation vector and perform classification on that feature.
