...
DEDENT         elif name == "Outputs": INDENT
            ...
            return self.outputs
DEDENT         elif name == "Capabilities": INDENT
            self.capabilities = ResultSet([('member', Capability)])
            return self.capabilities
DEDENT         elif name == "Tags": INDENT
            self.tags = Tag()
            return self.tags
...
DEDENT DEDENT class StackSummary(object): INDENT
    def __init__(self, connection=None): INDENT
        self.connection = connection
        self.stack_id = None
        self.stack_status = None
...
DEDENT DEDENT DEDENT class Parameter(object): INDENT
    def __init__(self, connection=None): INDENT
...
DEDENT DEDENT class Output(object): INDENT
    def __init__(self, connection=None): INDENT
        self.connection = connection
        self.description = None
        self.key = None
...
DEDENT DEDENT class Capability(object): INDENT
    def __init__(self, connection=None): INDENT
        self.connection = None
        self.value = None
...
DEDENT DEDENT class Tag(dict): INDENT
...
DEDENT         elif name == "Value": INDENT
            self._current_value = value
DEDENT         else: INDENT
            setattr(self, name, value)
        
DEDENT         if self._current_key and self._current_value: INDENT
            self[self._current_key] = self._current_value
            self._current_key = None
            self._current_value = None


DEDENT DEDENT DEDENT class NotificationARN(object): INDENT
    def __init__(self, connection=None): INDENT
        self.connection = None
        self.value = None
...
DEDENT DEDENT class StackResource(object): INDENT
    def __init__(self, connection=None): INDENT
        self.connection = connection
        self.description = None
...
DEDENT DEDENT class StackResourceSummary(object): INDENT
    def __init__(self, connection=None): INDENT
        self.connection = connection
...
DEDENT DEDENT class StackEvent(object): INDENT
